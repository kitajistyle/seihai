          ...
          >
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                <img src={player.avatar_url} className="w-16 h-16 rounded-full border-2 border-gray-200" alt={player.name} />
              ...
              <div className="flex-grow">
                ...
                {player.x_id && (
                  <a 
                    ...
                    className="inline-flex items-center gap-2 mt-3 px-3 py-1.5 bg-gray-900 hover:bg-gray-700 rounded-lg text-[10px] font-bold text-white transition-all hover:scale-105"
                  >
